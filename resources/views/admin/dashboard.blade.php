        ...
        <div class="main-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="m-l-15">
                                        <h2 class="m-b-0">{{$noOfOwner}}</h2>
                                        <p class="m-b-0 text-muted">Owner</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="m-l-15">
                                        <h2 class="m-b-0">{{$noOfInvoice}}</h2>
                                        <p class="m-b-0 text-muted">Invoice</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-t-50" style="height: 330px">
                                <canvas class="chart" id="line-chart-area"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="m-b-0">Cupon Codes</h5>
                            <div class="m-v-60 text-center" style="height: 195px; width: 100%; display: flex; align-items: center; justify-content: center">
    ...
    var result =
        $.ajax({
            ...
            success: function (data) {
                ...
                label =label.slice(label.length-12,label.length)
                dataset =dataset.slice(label.length-12,label.length)
               lineChart("line-chart-area",label,dataset,Math.max(...dataset)+5)
            },
            error: function (response) {
                alert("Something Wrong")
            }
        });
    function lineChart(id,labels,data,maxSize){
        ...
        const lineConfig = new Chart(lineCtx, {
                ...
                datasets: [{
                        label: 'Series A',
                        backgroundColor: '#52c4dc22',
                        borderColor:'#52c4dc',
                        pointBackgroundColor: '#52c4dc',
                        pointBorderColor: '#fff',
                        pointHoverBackgroundColor: '#5004dc',
                        pointHoverBorderColor: '#5004dc',
                        data: data
                    },]
                },
                options: {
