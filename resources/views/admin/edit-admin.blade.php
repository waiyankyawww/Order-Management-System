            ...
            <div class="container-fluid">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="phone_number" placeholder="Phone Number"
                                name="phone_number" required value="{{ $owner->phone_number }}">
                        </div>
                    </div>
                    <div class="form-row">
                                ...
                                <select class="select2" name="nrc_location" id="nrc_location" required>
                                    @foreach ($nrc_numbers as $nrc_number)
                                        @if ($owner->nrc_location == $nrc_number->prefix_en)
                                            <option value="{{ $nrc_number->prefix_en }}" selected>
                                                {{ $nrc_number->prefix_en }}</option>
                                        @else
                                            <option value="{{ $nrc_number->prefix_en }}">{{ $nrc_number->prefix_en }}
                                            </option>
                                        @endif
                                    @endforeach
                                    <option value=""></option>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" id="nrc_number" placeholder="NRC Number"
                                name="nrc_number" required value="{{ $owner->nrc_number }}">
                        </div>
                        <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {{-- <img src="/public/profiles/admins/{{ $owner->logo }}" width="300px"> --}}
                    </div>
